...
Write-Host ""
Write-Host " Time bands (no overlap between scripts, 1h slots, +1 day each):"
Write-Host "   Script 1: days 0-49 (earliest = NOW + 5 min)"
Write-Host "   Script 2: days 50-99    Script 3: days 100-149"
Write-Host "   Script 4: days 150-199  Script 5: days 200-249"
Write-Host "============================================================"
Write-Host ""
