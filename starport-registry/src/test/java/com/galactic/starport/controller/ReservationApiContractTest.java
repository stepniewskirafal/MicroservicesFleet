 ...
 *
 * <p>Verify the HTTP contract: status codes, content types, response body structure,
 * and header values. These tests guarantee that API consumers can rely on a stable
 * interface regardless of internal refactoring.
 */
...
class ReservationApiContractTest {
    ...
    // =========================================================================
    // Contract: POST /api/v1/starports/{code}/reservations — success with route
    // =========================================================================
    ...
    void contract_create_reservation_with_route_returns_201_and_complete_body() throws Exception {
        ...
        // when / then — verify complete response contract
    ...
    // =========================================================================
    // Contract: POST — success without route
    // =========================================================================
