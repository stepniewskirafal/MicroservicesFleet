...
public class LayeredArchitectureTest extends ArchUnitSpecification {
    ...
    void layered_dependencies_are_respected() {
        ArchRule rule = layeredArchitecture()
                ...
                .layer("API").definedBy(PKG_API)
                .layer("Application").definedBy(PKG_APPLICATION)
                .layer("Domain").definedBy(PKG_DOMAIN)
                .layer("Infrastructure").definedBy(PKG_INFRASTRUCTURE)
